...
export default function PartnersSection() {
  return (
    ...
    >
      {/* Header */}
      <div className="relative w-full flex justify-center items-center z-20 mb-10 lg:mb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center w-[90%] max-w-7xl mx-auto">
        {[
          ...
          <Image
            ...
            width={300}
            height={120}
            className="w-60 lg:w-80 object-contain transition duration-300 transform hover:-translate-y-3"
          />
        ))}
      </div>
    </section>
